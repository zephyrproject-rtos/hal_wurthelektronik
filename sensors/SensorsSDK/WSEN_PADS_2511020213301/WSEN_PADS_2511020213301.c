 ...
 */
static WE_sensorInterface_t padsDefaultSensorInterface = {.sensorType = WE_PADS,
                                                          .interfaceType = WE_i2c,
                                                          .options = {.i2c = {.address = PADS_ADDRESS_I2C_1, .burstMode = 0, .protocol = WE_i2cProtocol_RegisterBased, .useRegAddrMsbForMultiBytesRead = 0, .reserved = 0}, .spi = {.chipSelectPort = 0, .chipSelectPin = 0, .burstMode = 0, .duplexMode = 0, .reserved = 0, .sensorSpecificSettings = NULL}, .readTimeout = 1000, .writeTimeout = 1000},
                                                          .handle = 0};
 ...
 * @return Error Code
 */
static inline int8_t PADS_ReadReg(WE_sensorInterface_t* sensorInterface, uint8_t regAdr, uint16_t numBytesToRead, uint8_t* data) { return WE_ReadReg(sensorInterface, regAdr, numBytesToRead, data); }
 ...
 * @return Error Code
 */
static inline int8_t PADS_WriteReg(WE_sensorInterface_t* sensorInterface, uint8_t regAdr, uint16_t numBytesToWrite, uint8_t* data) { return WE_WriteReg(sensorInterface, regAdr, numBytesToWrite, data); }
 ...
 * @retval Error code
 */
int8_t PADS_setPressureThresholdLSB(WE_sensorInterface_t* sensorInterface, uint8_t thr) { return PADS_WriteReg(sensorInterface, PADS_THR_P_L_REG, 1, &thr); }
 ...
 * @retval Error code
 */
int8_t PADS_setPressureThresholdMSB(WE_sensorInterface_t* sensorInterface, uint8_t thr) { return PADS_WriteReg(sensorInterface, PADS_THR_P_H_REG, 1, &thr); }
 ...
 * @retval Error code
 */
int8_t PADS_getPressureThresholdMSB(WE_sensorInterface_t* sensorInterface, uint8_t* thrMSB) { return PADS_ReadReg(sensorInterface, PADS_THR_P_H_REG, 1, thrMSB); }
 ...
 * @retval Error code
 */
int8_t PADS_setPressureOffsetLSB(WE_sensorInterface_t* sensorInterface, uint8_t offset) { return PADS_WriteReg(sensorInterface, PADS_OPC_P_L_REG, 1, &offset); }
 ...
 * @retval Error code
 */
int8_t PADS_setPressureOffsetMSB(WE_sensorInterface_t* sensorInterface, uint8_t offset) { return PADS_WriteReg(sensorInterface, PADS_OPC_P_H_REG, 1, &offset); }
 ...
 */
int32_t PADS_convertPressure_int(int32_t rawPres) { return (rawPres * 100) / 4096; }
 ...
 */
int32_t PADS_convertDifferentialPressure_int(int32_t rawPres) { return (rawPres * 25600) / 4096; }
 ...
 */
float PADS_convertPressure_float(int32_t rawPres) { return ((float)rawPres) / 40960; }
 ...
 */
float PADS_convertDifferentialPressure_float(int32_t rawPres) { return ((float)rawPres) * 0.00625f; }
